...
<qgis version="3.16.3-Hannover" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="100000000" simplifyDrawingTol="1" simplifyMaxScale="1" readOnly="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="0" simplifyLocal="1">
  <flags>
  ...
  <DiagramLayerSettings priority="0" obstacle="0" showAll="1" dist="0" placement="1" zIndex="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="kiinteistotunnuksenSijainti">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="laajatSijaintitiedotKiinteistoraja">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="kiinteistotunnuksenSijainti" index="2" name=""/>
    <alias field="laajatSijaintitiedotKiinteistoraja" index="3" name=""/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="kiinteistotunnuksenSijainti" expression=""/>
    <default applyOnUpdate="0" field="laajatSijaintitiedotKiinteistoraja" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint field="kiinteistotunnuksenSijainti" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="laajatSijaintitiedotKiinteistoraja" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="kiinteistotunnus" desc="" exp=""/>
    <constraint field="kiinteistotunnuksenEsitysmuoto" desc="" exp=""/>
    <constraint field="kiinteistotunnuksenSijainti" desc="" exp=""/>
    <constraint field="laajatSijaintitiedotKiinteistoraja" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="kiinteistotunnuksenSijainti"/>
      <column hidden="0" type="field" width="-1" name="laajatSijaintitiedotKiinteistoraja"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="kiinteistotunnuksenSijainti"/>
    <field editable="1" name="kiinteistotunnus"/>
    <field editable="1" name="laajatSijaintitiedotKiinteistoraja"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="kiinteistotunnuksenEsitysmuoto"/>
    <field labelOnTop="0" name="kiinteistotunnuksenSijainti"/>
    <field labelOnTop="0" name="kiinteistotunnus"/>
    <field labelOnTop="0" name="laajatSijaintitiedotKiinteistoraja"/>
  </labelOnTop>
